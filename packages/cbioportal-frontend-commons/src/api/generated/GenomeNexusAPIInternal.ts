...
export default class GenomeNexusAPIInternal {
    ...
    fetchInsightMutationsByHugoSymbolGETWithHttpInfo(parameters: {
        ...
        return new Promise(function(resolve, reject) {
            ...
            if (parameters['hugoGeneSymbol'] !== undefined) {
                queryParameters['hugoGeneSymbol'] =
                    parameters['hugoGeneSymbol'];
            }
    ...
    fetchInsightMutationsByHugoSymbolGET(parameters: {
        ...
        return this.fetchInsightMutationsByHugoSymbolGETWithHttpInfo(
            parameters
        ).then(function(response: request.Response) {
            return response.body;
        });
    ...
    fetchInsightMutationsByMutationFilterPOST(parameters: {
        ...
        return this.fetchInsightMutationsByMutationFilterPOSTWithHttpInfo(
            parameters
        ).then(function(response: request.Response) {
            return response.body;
        });
